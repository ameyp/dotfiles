;; Copied from https://git.madhouse-project.org/algernon/brutalist-theme.el
;; The fixed-pitch messes with my default emacs font and I see no clean way to change it other
;; than customizing all affected faces myself. More straightforward to fork and change.
...
(defun brutalist-build-custom-theme (theme-name)
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-type-face ((t (:foreground ,fg :underline nil))))
   ...
   `(helm-keyword-face ((t (:foreground ,fg))))
   `(helm-selection ((t (:background ,bg-highlight-2))))
   `(highlight ((t nil)))
   `(lazy-highlight ((t (:background ,bg-highlight-3))))
