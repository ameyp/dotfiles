...
(let ((bg "#202020")
    ...
    (custom-theme-set-faces
     ...
     `(compilation-info ((t (:foreground "gold"))))
     ...
     `(company-tooltip-selection ((t :foreground ,fg :background "gray50")))
     `(company-scrollbar-fg ((t :background "gray200")))
     `(company-scrollbar-bg ((t :background "gray100")))
     `(company-tooltip-common ((t :foreground "gold")))
     `(company-tooltip-common-selection ((t :foreground "gold")))
     ...
     ;; log view
     `(log-view-file-face ((t (:bold t :background "gray50" :weight bold))))
     ...
     ;; enh-ruby-mode
     `(enh-ruby-op-face ((t (:bold t :foreground "#66FFFF" :background ,bg))))
